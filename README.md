...
Make sure this resource starts **after** your ESX / QBCore core components.

Add it to your server configuration and start the resource normally.
...
Maintained under the **J2SEC / JSquareSec** identity.
